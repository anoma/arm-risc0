...
where
    ...
    R: ReceiveInfo,
{
    pub consumed_kudo: K1,         // consumed resource
    pub created_kudo: K2,          // created resource
    pub consumed_denomination: D1, // consumed resource
    pub created_denomination: D2,  // created resource
