...
/// Uses risc0 serde deserialization (the default for zkvm circuits).
...
/// Encode the seal of the given proof for use with on-chain EVM Groth16 verifiers.
/// For Solana, use the seal encoding in solana-pa directly.
