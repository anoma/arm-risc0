...
fn print_kudo_main_elf_id() {
    ...
    std::fs::write("../elfs/kudo-main.bin", KUDO_MAIN_GUEST_ELF)
    ...
    println!(
        "Kudo-main ID: {:?}",
        Digest::from(KUDO_MAIN_GUEST_ID).as_bytes()
    );
}
