...
#[derive(Clone, serde::Serialize, serde::Deserialize)]
pub struct ComplianceWitnessVar {
...
#[derive(Clone, Debug, Default, serde::Serialize, serde::Deserialize)]
pub struct ComplianceInstanceVar {
...
impl ComplianceWitnessVar {
    pub fn constrain(&self) -> Result<ComplianceInstanceVar, ArmError> {
